// Service xử lý chụp màn hình và gửi đến backend
import type { ApiResponse, ScreenshotData } from '../types.js';

export class ScreenshotService {
  private static readonly BACKEND_URL = "http://localhost:3000/api/analyze"; // TODO: Move to config
   ...
   */
  static async sendToBackend(screenshot: ScreenshotData, question?: string): Promise<string> {
    try {
